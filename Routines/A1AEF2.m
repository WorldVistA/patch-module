A1AEF2 ;VEN/LGC - FUNCTIONS MINIMUM SET ; 10/20/14 6:25am
...
PRNTIT(JOBNM) ;
 N NODE S NODE=$NA(^XTMP(JOBNM))
 F  S NODE=$Q(@NODE) Q:$QS(NODE,1)'[JOBNM  D
 . W !
 . I $P(NODE,",",2)=4 W $O(^DD($P(NODE,",",3),0,"NM",""))_","
 . E  W $O(^DD($P(NODE,",",2),0,"NM",""))_","
 . W $P(NODE,",",2)_","
 . W $P(NODE,",",3)_","
 . W (9999999.999999-$P(NODE,",",4))_","
 . W $P(NODE,",",5)_","
 . W $P(NODE,",",6)_","
 Q
 ;  
